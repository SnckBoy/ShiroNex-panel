...
export default function NotificationsDropdown() {
  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>(() => {
    try {
      const saved = localStorage.getItem("shironex_notifications");
  ...
  useEffect(() => {
    localStorage.setItem("shironex_notifications", JSON.stringify(notifications));
  }, [notifications]);
