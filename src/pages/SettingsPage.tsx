...
export default function SettingsPage(): React.ReactElement {
  ...
  const { 
    ...
    enablePlayit, enableTutorial, enableLoginAnimation, enableRegistration, theme, appearance, accent, backgroundEffect, reducedMotion,
    setTheme, setAppearance, setAccent, setBackgroundEffect, setReducedMotion,
      ...
      {isAdmin && (
        <div className="bg-card border border-border-subtle rounded-2xl p-6 md:p-8 shadow-xl mt-8">
          ...
          <p className="text-muted-foreground text-sm mb-6 max-w-2xl">
            Trigger an automatic update of the ShiroNex. This will run git pull and rebuild the system. The panel will be unavailable for a few seconds during this process.
          </p>
          <button 
