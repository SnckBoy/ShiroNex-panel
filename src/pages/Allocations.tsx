...
export default function Allocations() {
  ...
  const add = async () => {
    ...
    if (!Number.isInteger(Number(form.portStart)) || !Number.isInteger(Number(form.portEnd)) || Number(form.portStart) < 1 || Number(form.portEnd) > 65535) return setError("Enter ports between 1 and 65535.");
    setBusy(true);
