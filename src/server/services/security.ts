...
// Keep the policy easy to use while preventing empty and trivially short passwords.
// Passwords are still stored only as bcrypt hashes; complexity is not substituted for hashing.
