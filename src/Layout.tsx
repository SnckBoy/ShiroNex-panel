...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className={`snx-app-shell flex h-[100dvh] w-full bg-background text-foreground font-sans overflow-hidden selection:bg-indigo-500/30`}>
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden relative bg-transparent">
        ...
        {/* Top Header */}
        <header className="snx-global-topbar h-16 flex items-center justify-between px-4 sm:px-6 bg-card/95 border-b border-border-subtle relative z-10 flex-shrink-0">
        ...
        {/* Main Content */}
        <main className={`flex-1 w-full h-full relative z-0 overflow-x-hidden overflow-y-auto pb-safe custom-scrollbar bg-background`}>
          <div className="p-4 sm:p-6 md:p-8 max-w-[1480px] mx-auto w-full">
            {children}
          </div>
        </main>
      </div>
